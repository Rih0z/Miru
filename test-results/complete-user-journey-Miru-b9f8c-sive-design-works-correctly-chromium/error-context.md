...
- Name: Miru Complete User Journey >> responsive design works correctly
- Location: /Users/kokiriho/Documents/Projects/Dating/Miru/tests/e2e/complete-user-journey.spec.ts:95:7
...
Locator: locator('text=恋愛ダッシュボード')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=恋愛ダッシュボード')

    at /Users/kokiriho/Documents/Projects/Dating/Miru/tests/e2e/complete-user-journey.spec.ts:100:50
```
