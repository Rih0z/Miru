...
- Name: Miru Complete User Journey >> AI integration features work
- Location: /Users/kokiriho/Documents/Projects/Dating/Miru/tests/e2e/complete-user-journey.spec.ts:222:7
...
Locator: locator('text=データインポート')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=データインポート')

    at /Users/kokiriho/Documents/Projects/Dating/Miru/tests/e2e/complete-user-journey.spec.ts:230:51
```
